    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (FileConfig.IsProfileValid())
            {
                ...
                Console.WriteLine("tempArgs: " + tempArgs);
                Console.WriteLine("procArgs: " + procArgs);

                var serverProcess = new Process
                {
                    StartInfo = new ProcessStartInfo
                    {
                        FileName = FileConfig.GetJavaPath(),
                        Arguments = procArgs,
        ...
        static StreamWriter serverStart(Process process)
        {
            ...
            {
                Console.WriteLine("MC Monitor cannot find the jar, check the file path again.\n  Error as follows:");
                Console.WriteLine(e.ToString());
                Console.WriteLine("Process Info:");
                Console.WriteLine(process.StartInfo.FileName.ToString());
                Console.WriteLine(process.StartInfo.Arguments.ToString());
                Console.WriteLine("Process Working Directory:");
